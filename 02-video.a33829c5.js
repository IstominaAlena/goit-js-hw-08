...
"use strict";var e=o(require("lodash/throttle"));function o(e){return e&&e.__esModule?e:{default:e}}const t=document.querySelector("iframe"),n=new Vimeo.Player(t),r=function(e){localStorage.setItem("videoplayer-current-time",JSON.stringify(e))};n.on("timeupdate",(0,e.default)(r,1e3));const l=localStorage.getItem("videoplayer-current-time");let a;try{a=JSON.parse(l)}catch(c){console.log(c.name),console.log(c.message)}n.setCurrentTime(a.seconds).then(function(e){console.log(e)}).catch(function(e){switch(e.name){case"RangeError":console.log(e.message);break;default:console.log(e.name),console.log(e.message)}});
},{"lodash/throttle":"Ywd4"}]},{},["iiAF"], null)
//# sourceMappingURL=/goit-js-hw-08/02-video.a33829c5.js.map