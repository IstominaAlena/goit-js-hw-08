...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form"),r=a.querySelector('input[type="email"]'),o=a.querySelector('textarea[name="message"]'),l=localStorage.getItem("feedback-form-state"),u=JSON.parse(l);function n(){localStorage.getItem("feedback-form-state")&&(r.value=u.email,o.value=u.message)}n(),a.addEventListener("input",(0,e.default)(s,500));const c={};function s(){c[r.name]=r.value,c[o.name]=o.value,localStorage.setItem("feedback-form-state",JSON.stringify(c))}function m(e){e.preventDefault(),r.value="",o.value="",localStorage.removeItem("feedback-form-state")}a.addEventListener("submit",m);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.c9bfaf8a.js.map